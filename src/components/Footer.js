...
const Footer = () => {
    return (
        <div className='max-w-[1200px] overflow-hidden flex  flex-col items-center justify-center pb-7' style={{fontFamily:"Mona-Sans"}}>
            ...
            <div className='flex items-center justify-between py-[44px] w-full max-laptop:py-[12px] max-tablet:flex-col max-laptop:gap-3'>
                ...
                <ul className='flex gap-3 text-sm text-gray-500'>
                    ...
                    <li><a href="#freelencers">Freelencers</a></li>
