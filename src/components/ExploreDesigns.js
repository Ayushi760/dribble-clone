...
const ExploreDesigns = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full mt-[43px] mb-[150px]'>
      ...
      <button className='px-6 mt-12 text-sm font-medium border-[1.5px] border-black rounded-full h-14 cursor-pointer hover:border-gray-600 hover:text-gray-600'>Browse more inspiration</button>
